...
# Author: KTmodz
# GitHub: https://github.com/KTmodz333
# Version: 1.0
#########################################
...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/KTmodz333/KTboomb/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf KTboomber && git clone https://github.com/KTmodz333/KTboomb > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd KTboomber && python KTboomber.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : KTmodz                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/KTmodz333/KTboomb \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Khalid Mahmud              \033[37mV1.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mKTBoomber\n")
        time.sleep(0.6)
